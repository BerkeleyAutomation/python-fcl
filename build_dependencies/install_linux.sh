...
cd octomap
$CMAKE . -D CMAKE_BUILD_TYPE=Release -D BUILD_OCTOVIS_SUBPROJECT=OFF -D BUILD_DYNAMICETD3D_SUBPROJECT=OFF -D CMAKE_CXX_STANDARD=17 -D CMAKE_CXX_FLAGS="-std=c++17"
make -j4
make install
cd ..
